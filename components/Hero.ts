...
import { generateSiteImage } from '../services/gemini.ts';

export default defineComponent({
  name: 'Hero',
  setup() {
    const bgImage = ref('https://images.unsplash.com/photo-1485846234645-a62644f84728?auto=format&fit=crop&q=80&w=1920');
  ...
  template: `
    <section class="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div class="absolute inset-0 z-0">
        ...
        ></div>
        <div class="absolute inset-0 bg-gradient-to-b from-gray-950/20 via-transparent to-gray-950"></div>
      ...
      <div class="relative z-10 max-w-5xl mx-auto px-4 text-center">
        <h1 class="text-5xl md:text-7xl lg:text-8xl font-black tracking-tight mb-6 text-white leading-tight">
          人人都是<br />
